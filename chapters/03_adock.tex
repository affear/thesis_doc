...
% when we start oscard container the script ./bin/run_proxy is run

\todo{figure of oscard functioning}
...
\todo{screenshot of bifrost dashboard}
\todo{screenshot of polyphemus}